...
real16 Phi_t = {g_ttt, g_xtt, g_ytt, g_ztt, g_ttx, g_xtx, g_ytx, g_ztx, g_tty, g_xty, g_yty, g_zty, g_ttz, g_xtz, g_ytz, g_ztz};
real16 Phi_x = {g_txt, g_xxt, g_yxt, g_zxt, g_txx, g_xxx, g_yxx, g_zxx, g_txy, g_xxy, g_yxy, g_zxy, g_txz, g_xxz, g_yxz, g_zxz};
real16 Phi_y = {g_tyt, g_xyt, g_yyt, g_zyt, g_tyx, g_xyx, g_yyx, g_zyx, g_tyy, g_xyy, g_yyy, g_zyy, g_tyz, g_xyz, g_yyz, g_zyz};
real16 Phi_z = {g_tzt, g_xzt, g_yzt, g_zzt, g_tzx, g_xzx, g_yzx, g_zzx, g_tzy, g_xzy, g_yzy, g_zzy, g_tzz, g_xzz, g_yzz, g_zzz};
real16 Upsilon = -uUPt * Phi_t - uUPx * Phi_x - uUPy * Phi_y - uUPz * Phi_z;
real16 UpsilonT = Upsilon.s048c159d26ae37bf;
real16 gUP = {gray_subbfj*(K(2)*gray_subb*gray_subbc*gray_subbei*gray_subbfa*gray_subbfb*gray_subfj*gray_subhi - gray_subb*gray_subbfc*gray_subbfe*gray_subdd*gray_subec*gray_subhi - gray_subb*gray_subbfc*gray_subbff*gray_subdd*gray_subec*gray_subfj - gray_subbb*gray_subbei*gray_subbfc*gray_subbfd*gray_subdd*gray_subfj*gray_subhi + gray_subbfh),
gray_subbga,
gray_subbgb,
gray_subbgc,
gray_subbga,
